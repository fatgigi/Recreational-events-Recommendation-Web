...
public class MongoDBConnection implements DBConnection {
	...
	public void saveItem(Item item) {
		FindIterable<Document> iterable = db.getCollection("item").find(eq("item_id", item.getItemId()));
		// 因为item_id unique, so iterable must have at most one
		if (iterable.first() == null) { // if there is already one, no need to insert
